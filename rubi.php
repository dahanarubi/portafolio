...
<head>
    ...
    <style>
        ...
        /* CONTAINER DE FOTO Y DATOS */
        .profile-header {
            background: linear-gradient(145deg, #f0f4f8, #e3ebf2);
            padding: 20px;
            border-radius: 12px;
...
<section class="container mt-4">
    ...
    <div class="profile-header d-flex flex-wrap align-items-center gap-4">
        <img src="image/rubi.jpeg" class="img-fluid profile-pic" alt="Foto Dahana Rubi">
        <div>
            <h3 class="mb-1">Dahana Rubi Montejano Rodriguez</h3>
            <p class="mb-1 text-muted">Estudiante de Ingeniería en Desarrollo de Software · Área Multiplataforma</p>
            <p class="mb-0 text-muted">Email: 24040093@alumno.utc.edu.mx | LinkedIn: <a href="#" target="_blank">Perfil</a></p>
        </div>
    </div>
